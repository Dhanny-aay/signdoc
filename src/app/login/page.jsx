        ...
        <div className="w-full max-w-md rounded-2xl border border-gray-200 p-6 shadow-sm bg-white">
          ...
          <form onSubmit={handleEmailAuth} className="mt-6 space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-lg border border-gray-200 px-3 py-2 pl-9 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full inline-flex items-center justify-center gap-2 rounded-lg bg-blue-600 text-white py-2.5 hover:bg-blue-700 disabled:opacity-60 transition-colors"
            >
              {loading ? (
                <>
