        ...
        <section className="px-4 sm:px-6 md:px-8 lg:px-14 w-full py-12 sm:py-16 lg:py-20 bg-gray-50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Full-Canvas Workspace</h3>
            ...
            <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Perfect Freehand Drawing</h3>
              <p className="text-sm sm:text-base text-gray-600">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Premium Typed Signatures</h3>
              <p className="text-sm sm:text-base text-gray-600">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Smooth Drag & Drop</h3>
              <p className="text-sm sm:text-base text-gray-600">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Full PDF Rendering</h3>
              <p className="text-sm sm:text-base text-gray-600">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Undo/Redo System</h3>
              <p className="text-sm sm:text-base text-gray-600">
        ...
        <section className="px-4 sm:px-6 md:px-8 lg:px-14 w-full py-12 sm:py-16 lg:py-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Upload PDF</h3>
              <p className="text-sm sm:text-base text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Create Signature</h3>
              <p className="text-sm sm:text-base text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Place & Position</h3>
              <p className="text-sm sm:text-base text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Save & Download</h3>
              <p className="text-sm sm:text-base text-gray-600">
        ...
        <section className="px-4 sm:px-6 md:px-8 lg:px-14 w-full py-12 sm:py-16 lg:py-20 bg-gray-50">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            <div className="bg-white p-4 sm:p-6 rounded-xl border border-gray-200 text-center">
              ...
              <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">Perfect Freehand</h3>
            ...
            <div className="bg-white p-4 sm:p-6 rounded-xl border border-gray-200 text-center">
              ...
              <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">React PDF</h3>
            ...
            <div className="bg-white p-4 sm:p-6 rounded-xl border border-gray-200 text-center">
              ...
              <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">Smooth Transforms</h3>
            ...
            <div className="bg-white p-4 sm:p-6 rounded-xl border border-gray-200 text-center">
              ...
              <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">Supabase</h3>
      ...
      <footer className="border-t border-gray-200 py-12 text-center bg-white">
        <div className="px-4 sm:px-6 md:px-8 lg:px-14 w-full">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="text-base sm:text-lg font-semibold text-gray-900">signdoc 4.0</span>
          </div>
